...
## 4. Mecánicas:
  * A cada jugador se le asignará uno de los cuatro personajes disponibles y competiremos en un modo todos contra todos, con un número de     jugadores de 2 a 4.
